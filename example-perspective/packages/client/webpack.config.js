...
const LibName = "example-client-components";
...
function copyToResources() {
    const resourceFolder = path.resolve(__dirname, '../../..', 'example-gateway/src/main/resources/mounted/');
...
const config = {
    ...
    entry: {
        example:  path.join(__dirname, "./typescript/example-client-components.ts")
    },
