...
import com.tamakicontrol.util.ReflectionUtils;
...
public class EntityTagMapper<T extends Object> {
    ...
    private static final LoggerEx log = LoggerEx.newBuilder().build(EntityTagMapper.class);
     ...
     */
    private ManagedTagProvider provider; // todo

    @SuppressWarnings("unchecked")
    public EntityTagMapper(ManagedTagProvider provider, String rootPath, T model, Class<T> type) {
